(function ($) {
    ...
    var methods = {
        ...
        build : function(){//Constructs the necessary structure to slider
          var slides = el.find(".slide").each(function(e){
            ...
            if(el.vars.bullets){//verify if is to create bullets and creates a bullet for each slide and makes the current slide bullet
          ...
          el.find(".slide").each(function(){
            $(this).children("[animate]").each(function(){
        ...
        coverImages : function(){//find images with [willslide='full'] attr and makes them cover all slide area
          el.find("img[full]").each(function(){
  ...
  $.willslide.defaults = {
    ...
    bullets:true,                    //create slider bullets
